...
|---|---|---|---|---|
| **1** | [#47](https://github.com/hidetzu/kagima/issues/47) | ⚠ **Durable Objects の課金条件を確かめる** | ⚠ **継続的な running cost は Owner 判断である**([`../PRODUCT.md`](../PRODUCT.md) § 6)。⚠ **方針は決まったが、⚠ 実額は誰も見ていない** | ⚠ **Owner** |
...
⚠ **1 が「継続コストあり」でも、⚠ もう止まらない** — ⚠ **Owner が方針を決めたからである。**
⚠ **止まらないが、⚠ 金額は確かめる。** ⚠ **確かめずに載せることを「決まっている」とは言わない。**
