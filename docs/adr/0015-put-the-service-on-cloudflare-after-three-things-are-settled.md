...
> ⚠ **1 番目は片付いた**(2026-09-06、[`0022`](0022-start-on-cloudflares-free-tier-with-one-durable-object-per-room.md))。
> ⚠ **Free で始める。** ⚠ **境界は 28.21 room-hours/day。**
> ⚠ **ルームの状態は、⚠ ノックも含めて 1 ルーム = 1 DO に集約する。**
