...
|---|---|---|---|
| U1 | ⚠ **P2P だけで何割の相手とつながるか** | 中心体験そのもの。つながらなければ v0.1.0 は成立しない | ⚠ **Owner 判断待ち**(§ 2) |
...
- MUST: ⚠ **A を実装して、実際に何割つながらないかを自分で測る。**
  ⚠ **他所の 15〜20% を根拠に B を選ぶのは、推測を測定の顔で使うことである。**
- ⚠ **したがって U1 は「今すぐ Owner に訊く」ではない。** ⚠ **A を作り、測り、その数字を持って
  訊く**([`../.claude/rules/owner-decisions.md`](../.claude/rules/owner-decisions.md) —
  ⚠ **測れば決まることを訊かない**)。
