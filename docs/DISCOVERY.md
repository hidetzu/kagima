...
| # | 何をするか | ⚠ 何が分かれば次の判断ができるか | 実装 |
|---|---|---|---|
| **E1** | ⚠ **非技術者 3 人に、⚠ URL と合言葉を別経路で渡して入ってもらい、⚠ 詰まった場所を記録する** | ⚠ **入口そのものが成立するか。** ⚠ **成立しないなら、⚠ どの方向へ広げても土台が無い** | ⚠ **ゼロ。** ⚠ 診断パネルの `waited alone` がそのまま手渡しの摩擦である |
| **E2** | ⚠ **5 人に「直近 3 ヶ月で、⚠ 連絡先を渡したくないが話す必要があった場面」があったかを聞く** | ⚠ **H1 が実在するか。** ⚠ **具体例が出てこなければ H1 を捨てる** | ゼロ |
| **E3** | ⚠ **一文の説明を 3 通り書き、⚠ 3 人に見せて「何のサービスだと思ったか」を言ってもらう** | ⚠ **何を売りにすると伝わるか。** ⚠ **プライバシーが刺さるのか、⚠ 手間の無さが刺さるのか** | ゼロ |
| **E4** | ⚠ **E2 と同じ聞き取りの中で、⚠ 「そのとき写真や書類も渡したかったか」を聞く** | ⚠ **H4 が単体の価値か、⚠ 会話の付属か。** ⚠ **単体なら、⚠ それは別のプロダクトかもしれない** | ゼロ |
| **E5** | ⚠ **いまの kagima で、⚠ 離れた相手にカメラで何かを 1 回見せてみる** | ⚠ **H5 に専用のデバイス統合が要るのか、⚠ いまの通話で足りるのか** | ⚠ **ゼロ。** ⚠ 手持ちのカメラを向けるだけ |
