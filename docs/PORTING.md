...
- 日付: **2026-09-06**
- 目的: ⚠ **[kagima#62](https://github.com/hidetzu/kagima/issues/62)(ハートビートをどう果たすか)を
  Owner が判断するための材料**
...
⚠ **so いまのハートビートは、⚠ 相手のページが壊れていても、⚠ フリーズしていても、
...
⚠ **アプリケーション層のハートビートのほうが、⚠ 測っているものは 強い。**

⚠ **ただし、⚠ 強いほうが常に良いとは言っていない。**
⚠ **フレームが 2 つ増え、⚠ クライアントが変わり、⚠ 移植が終わるまでのあいだハートビートの実装が
2 つになる**(⚠ `CLAUDE.md` § 3 が最も嫌う形)。⚠ **どちらを取るかは測定では決まらない。**

⚠ **判断が要るのは、⚠ いま動いている Node 版のハートビートを、⚠ まだ存在しない側に合わせて
先に変えるかどうかである** — ⚠ **[kagima#62](https://github.com/hidetzu/kagima/issues/62)
の案 3。**

---

> ⚠ **語について。** ⚠ **この文書は最初「心拍」と書いていた。**
> ⚠ **プロジェクトの語は「ハートビート」であり**([`adr/0010`](adr/0010-a-room-lives-while-somebody-is-in-it-and-not-longer.md))、
> ⚠ **コードも `HEARTBEAT_MS` である。** ⚠ **借りずに訳したので、⚠ 借り直した**
> (`CLAUDE.md` § 4: ⚠ **ドメインが既に付けた名前をそのまま借りる**)。
